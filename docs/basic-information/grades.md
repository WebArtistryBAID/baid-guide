...
在十二年级申请时，你可以申请你的**正式成绩单 (official transcript)**。正式成绩单由学校直接提交给申请大学。为了保证学术诚信，学生不能查看正式成绩单。正式成绩单载明了每个学期、每个课程的字母等级以及你的 **平均绩点 (grade point average，简称 GPA)**。你的最终 GPA 是根据所有课程的加权 4.0 成绩，按照年级权重计算出的加权平均值，最高为 4.5。年级权重可能是 `G9 : G10 : G11 : G12 = 5 : 6 : 3 : 4`。北京中学国际部不报告**年级排名 (class rank)**。
